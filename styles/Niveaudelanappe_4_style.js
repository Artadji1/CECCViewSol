...
var style_Niveaudelanappe_4 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Niveau nap");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 5.000000) {
        ...
        image: new ol.style.Circle({radius: 4.0 + size,
            stroke: new ol.style.Stroke({color: 'rgba(255,255,255,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0.0}), fill: new ol.style.Fill({color: 'rgba(8,104,172,1.0)'})}),
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 20.000000 && value <= 64.100000) {
            style = [ new ol.style.Style({
